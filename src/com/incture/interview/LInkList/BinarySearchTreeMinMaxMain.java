...
public class BinarySearchTreeMinMaxMain {
    ...
    public static TreeNode createBinarySearchTree()
    {
        ...
        TreeNode node20=new TreeNode(12);
        TreeNode node10=new TreeNode(410);
        TreeNode node30=new TreeNode(530);
        TreeNode node60=new TreeNode(343);
        TreeNode node50=new TreeNode(456);
        TreeNode node70=new TreeNode(744);
        TreeNode node5=new TreeNode(543);
        TreeNode node55=new TreeNode(532);
